          ...
          <div className="grid md:grid-cols-3 gap-8 text-center md:text-left">
            ...
            <div>
              ...
              <div className="flex justify-center md:justify-start space-x-4">
                <a href="https://www.linkedin.com/in/nomfundo-nolwazi-manyoni-85b438226" className="text-gray-600 hover:text-gray-900 transition-colors">
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-gray-700 text-sm mb-2">Front-End: HTML5, CSS, JavaScript, React.js, Tailwind CSS</p>
                    <p className="text-gray-700 text-sm mb-2">Back-End: Node.js, Express.js, Python, Django</p>
                    <p className="text-gray-700 text-sm mb-2">Database: MongoDB, MySQL, PostgreSQL</p>
                    <p className="text-gray-700 text-sm mb-2">API Development: RESTful APIs, JSON, XML</p>
                    <p className="text-gray-700 text-sm mb-2">Embedded Systems: Arduino, Raspberry Pi, Robotics Programming</p>
                    <p className="text-gray-700 text-sm mb-2">Cloud Computing: Microsoft Azure (App Services, Azure SQL, Functions, DevOps, Storage)</p>
                    <p className="text-gray-700 text-sm mb-2">Software Design Patterns: MVC, OOP, Microservices</p>
                    <p className="text-gray-700 text-sm">Other: Git, Docker, Figma, GitHub, Azure DevOps</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Professional & Soft Skills</h4>
                    <p className="text-gray-700 text-sm mb-2">Mentoring & teaching</p>
                    <p className="text-gray-700 text-sm mb-2">Project management & Scrum methodology</p>
                    <p className="text-gray-700 text-sm mb-2">Teamwork & Adaptability to new technologies</p>
                    <p className="text-gray-700 text-sm mb-4">Effective communication and presentation skills</p>

                    <h4 className="font-semibold text-gray-900 mb-2">Tools</h4>
                    <p className="text-gray-700 text-sm mb-2">IDEs: Visual Studio, VS Code, Eclipse, PyCharm</p>
                    <p className="text-gray-700 text-sm mb-2">Version Control: Git, GitHub</p>
                    <p className="text-gray-700 text-sm mb-2">Cloud & Deployment: Azure, AWS, Netlify</p>
                    <p className="text-gray-700 text-sm mb-2">Testing & Debugging: Postman, NUnit, Jest</p>
                    <p className="text-gray-700 text-sm mb-4">Design & Prototyping: Figma, Adobe XD</p>

                    <h4 className="font-semibold text-gray-900 mb-2">Other</h4>
                    <p className="text-gray-700 text-sm mb-2">Microsoft Power Platform (Power Apps, Power Automate, Power BI)</p>
                    <p className="text-gray-700 text-sm mb-2">AI & Machine Learning: Azure Machine Learning, TensorFlow</p>
                    <p className="text-gray-700 text-sm">Embedded Systems: Arduino, Raspberry Pi, Robotics Programming</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {activeModal === 'contact' && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-2xl w-full">
            ...
            <div className="p-6">
 <form 
      action="https://formspree.io/f/mrbzdged" 
      method="POST"
      className="space-y-6"
    >
